...
/*
  All generateRatingElement does is either put "NO RATING FOUND" or generates an image based on the imgMapper above
  Render fills in the headers with the props and calls generateRatingElement() for the rating.
*/
